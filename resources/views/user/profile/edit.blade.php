                    ...
                    <div class="card">
                        <form action="{{ route('user.profile.update', $user->id) }}"
                            ...
                            <div class="form-group">
                                ...
                                <input value="{{$user->email}}" name="email" id="email" type="email"
                            ...
                            <div class="form-group">
                                ...
                                <input value="{{$user->password}}" name="password" id="password"
                                       type="password" class="form-control" placeholder="Masukkan password">
                            ...
                            <div class="form-group">
                                ...
                                <input value="{{$user->phone_number}}" name="phone_number" id="phone_number"
                                type="number" class="form-control" placeholder="Masukkan nomor telepon">
